...
public class DataProviders {
	...
	@DataProvider(name = "compCustomerCreation")
	public Object[][] enterCompCustomerdetails() {

		// Totals rows count
		int rows = obj.getRowCount("CompCustomerCreation");
		// Total Columns
		int column = obj.getColumnCount("CompCustomerCreation");
		int actRows = rows - 1;
		//Created an object of array to store data
		Object[][] data = new Object[actRows][1];
		...
		for (int i = 0; i < actRows; i++) {
			Map<String, String> hashMap = new HashMap<>();
			for (int j = 0; j < column; j++) {
				hashMap.put(obj.getCellData("CompCustomerCreation", j, 1),
						obj.getCellData("CompCustomerCreation", j, i + 2));
			}
			data[i][0]=hashMap;
		}
		return data;
	...
	@DataProvider(name = "carRentalRuleCreation")
	public Object[][] enterCarRentalRuledetails() {

		// Totals rows count
		int rows = obj.getRowCount("CarRentalRule");
		// Total Columns
		int column = obj.getColumnCount("CarRentalRule");
		int actRows = rows - 1;
		//Created an object of array to store data
		Object[][] data = new Object[actRows][1];
		...
		for (int i = 0; i < actRows; i++) {
			Map<String, String> hashMap = new HashMap<>();
			for (int j = 0; j < column; j++) {
				hashMap.put(obj.getCellData("CarRentalRule", j, 1),
						obj.getCellData("CarRentalRule", j, i + 2));
			}
			data[i][0]=hashMap;
		}
		return data;
	...
	@DataProvider(name = "carRentalRuleCreationEdit")
	public Object[][] enterCarRentalRuledetailsEdit() {

		// Totals rows count
		int rows = obj.getRowCount("CarRentalRuleEdit");
		// Total Columns
		int column = obj.getColumnCount("CarRentalRuleEdit");
		int actRows = rows - 1;
		//Created an object of array to store data
		Object[][] data = new Object[actRows][1];
		...
		for (int i = 0; i < actRows; i++) {
			Map<String, String> hashMap = new HashMap<>();
			for (int j = 0; j < column; j++) {
				hashMap.put(obj.getCellData("CarRentalRuleEdit", j, 1),
						obj.getCellData("CarRentalRuleEdit", j, i + 2));
			}
			data[i][0]=hashMap;
		}
		return data;
