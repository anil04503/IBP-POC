 ...
 * 
 */
package com.dryrun.actiondriver;
...
public class Action extends BaseClass{
	...
	public static void click(WebElement ele) {
		...
		try {
			...
			Log.info("The " +ele+ " is clicked successfully");
			Log.info("The click keyword executed successfully");
		}
		catch(Throwable t) {
			Log.info("The "+ele+ " is not clicked successflly"+t.getMessage());
	...
	public static String getText(WebElement ele) {
		...
		try {
			...
			gettext = ele.getText();
			Log.info("The text has been feteched successfully for the element "+ele);
			Log.info("The getText keyword executed successfully");
		}
		catch(Throwable t) {
			Log.info("The text has been not feteched successfully for the element "+ele+ t.getMessage());
	...
	public static void elementFocus(WebElement ele) {
		...
		try {
			...
			Actions act = new Actions(getDriver());
			act.moveToElement(ele).build().perform();
			Log.info("The " +ele+ " is focused successfully");
			Log.info("The elementFocus keyword executed successfully");
		}
		catch(Throwable t) {
			Log.info("The " +ele+ " is not focused successfully"+t.getMessage());
...
public static void clearData(WebElement ele) {
	...
	public static void JSelementFocus(WebElement ele) {
		...
		try {
			...
			Log.info("The " +ele+ " is not focused successfully");
	...
	public static void explicitWaitVisibility(WebDriver driver, WebElement element, int timeOut ) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut));
		wait.until(ExpectedConditions.visibilityOf(element));
	}
	public static void explicitWaitinVisibility(WebDriver driver, WebElement element, int timeOut ) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut));
		wait.until(ExpectedConditions.visibilityOf(element));
	}
	public static void explicitWaitClickable(WebDriver driver, WebElement element, int timeOut ) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut));
